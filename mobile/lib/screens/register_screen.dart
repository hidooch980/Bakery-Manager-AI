          ...
          children: [
            ...
            DropdownButton<String>(
              ...
              items: const [
                ...
                DropdownMenuItem(value: 'DOUGH_MAKER', child: Text('خمیرگیر')),
                DropdownMenuItem(value: 'DOUGH_DIVIDER', child: Text('چانه‌گیر')),
                DropdownMenuItem(value: 'ACCOUNTANT', child: Text('حسابدار')),
